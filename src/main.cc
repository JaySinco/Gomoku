...
int main() {
	...
	//auto net = std::make_shared<FIRNet>("FIR-6x6by4_950.param");
	//auto net2 = std::make_shared<FIRNet>("FIR-8x8by5_4300.param");
	//auto p1 = RandomPlayer("p1");
	//auto p2 = HumanPlayer("jaysinco");
	//auto p3 = MCTSPurePlayer("mcts_pure", 400);
	//auto p4 = MCTSDeepPlayer("mcts_deep1", net, 1600);
	//auto p5 = MCTSDeepPlayer("mcts_deep2", net, 800);
